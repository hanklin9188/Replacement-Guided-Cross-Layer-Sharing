...
the complete sharing partition and define the normalized joint cost
\begin{equation}
C^\star
=
\frac{1}{L}\left[
...
(c) $C^\star$ is compared directly with
...
normalized simultaneous cost in Eq.~\eqref{eq:c-star}. As compression increases,
...
the normalized simultaneous cost.
